...
System.out.println("Enter the minimum probability:");//used to calculated the drop probabilty 
(max-min) 
double minProbability = scanner.nextDouble(); 
System.out.println("Enter the threshold value:");//the value after which the congestion control 
comes to action  
...
//checking the threshold value and the probabilty to check whether to accept or reject the 
packet 
} 
} 
} else { 
...
private static double calculateDropProbability(int currentQueueLength, int queueSize, double 
